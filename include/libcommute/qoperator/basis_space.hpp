 ...
 *
 ******************************************************************************/
#ifndef LIBCOMMUTE_QOPERATOR_BASIS_SPACE_HPP_
#define LIBCOMMUTE_QOPERATOR_BASIS_SPACE_HPP_
...
public:
  ...
  basis_space(index_types const& indices) : indices_(indices) {}
  basis_space(index_types && indices) : indices_(std::move(indices)) {}
