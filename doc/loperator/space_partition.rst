...
.. class:: template<typename HSType> space_partition
  ...
  *Defined in <libcommute/loperator/space_partition.hpp>*
  ...
  .. function:: template<typename LOpScalarType, int... LOpAlgebraIDs> \
    ...
    Partition Hilbert space :var:`hs` into invariant subspaces of Hermitian
    linear operator :var:`h` (Hamiltonian).
  ...
  .. function:: template<typename LOpScalarType, int... LOpAlgebraIDs> \
    ...
    Partition Hilbert space :var:`hs` into invariant subspaces of Hermitian
    linear operator :var:`h` (Hamiltonian). This constructor reveals all
    matrix elements of :var:`h` and writes them into :var:`me`.
  ...
  .. function:: template<typename LOpScalarType, int... LOpAlgebraIDs> \
    ...
    :var:`Od` and :var:`O` generate only one-to-one connections between the
    subspaces.

    Matrix elements of :var:`Od` and :var:`O` will be returned as a pair of
  ...
  .. function:: template<typename LOpScalarType, int... LOpAlgebraIDs> \
    ...
    Analyze connections between subspaces generated by operator :var:`op`.
  ...
  .. function:: template<typename F> \
    ...
    Apply functor :var:`f` to all basis states in a given space partition.
...
.. function:: template <typename HSType, \
  ...
  *Defined in <libcommute/loperator/space_partition.hpp>*
  ...
  from a linear operator :var:`h` and a Hilbert space :var:`hs`.
